# Modification of paper: https://arxiv.org/pdf/1802.03691.pdf
# that uses the same tree decoder but transformer encoder

import torch
from torch import nn


class TransformerEncoderTreeDecoder(nn.Module):
    ...
    def forward(self, src, target_trees, epoch_num):
        ...
        input_emb = self.encoder.forward(input_emb)
