...
"""
C Source Code Generator/Sampler - Version 3
...
(2) GCC -O0 (lowest optimization) DOES indeed pre-compute values when 
    ...
    For this reason, the generation process introduces at least one 
      literal-assigned variable for any operator (that is not otherwise 
      set to other value) 
        See: expr_00.c
"""
