...
import cast_function_call_visitor as call_order
...
from metadata import TypedMetadata, VariableFromSource
...
class CASTToAIRVisitor(CASTVisitor):
    ...
    def visit_node_list_and_flatten(self, nodes: typing.List[AstNode]):
